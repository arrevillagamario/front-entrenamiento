        ...
        <div className="w-full max-w-lg p-6 bg-gray-800 rounded-lg shadow-lg bg-gradient-to-r from-green-400 to-blue-500 transition-all duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl">
          <div className="bg-gray-800 bg-opacity-90 p-6 rounded-lg text-white">
            ...
            <p className="text-lg text-gray-300 text-center mb-4">
              ¡Enhorabuena por embarcarte en este nuevo camino! Basado en tus
              datos (peso: {JSON.parse(localStorage.getItem("userData")).weight}{" "}
              kg; altura: {JSON.parse(localStorage.getItem("userData")).height}{" "}
              m; edad: {JSON.parse(localStorage.getItem("userData")).age} años),
              tienes una rutina de {ejercicios.length} ejercicios para ayudarte
              a {JSON.parse(localStorage.getItem("userData")).goal}.
            </p>
            <button
              onClick={handleStart}
